...
function(Story, $rootScope, $scope, $timeout, syncService, Auth, persistenceService, $q, $sce){
    var vm = this;
    vm.getData = function(){
        ...
        vm.getData().then(function(result){            
            ...
            if ($rootScope.stories !== undefined) {
                for (var i = 0 ; i < $rootScope.stories.length ; i++) {
                    if ($rootScope.stories[i].title.toString().toLowerCase().indexOf(srch.toLowerCase()) > -1 ||
                        $rootScope.stories[i].introduction.toString().toLowerCase().indexOf(srch.toLowerCase()) > -1 ||
                        ($rootScope.stories[i].content !== undefined && items[i].content.toString().toLowerCase().indexOf(srch.toLowerCase()) > -1)) {
